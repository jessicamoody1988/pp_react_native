export const ARTISTS = [
    {
        ...
        image: 'assets/images/Artists/CharolotteDeWitte_360x360.jpg',
        genres: ['techno'],
        home: 'Belgium',
        description: 'No Sleep. A mindset and work ethic claimed by many but endured by few. Charlotte de Witte’s a Belgian born DJ whose surge on the scene has resulted in her being one of the most sought-after names in electronic music today.'
    },
    {
        id: 1,
        spotlight: false,
        name: 'Carl Cox',
        image: 'assets/images/Artists/CarlCox_360x360.jpg',
        genres: ['house', 'tech house', 'techno'],
        home: 'United Kingdom',
        description: 'Carl Cox is a British house and rechno record producer and DJ. He runs the record label Intec Digital. He has performed at numerous clubs and events worldwide and has served as a monthly DJ for BBC Radio 1\'s Essential Mix. He has hosted a residency known as \'Music is Revolution\' every summer season at the world renowned nightclub, Space Ibiza, from 2001 to 2016.'
    },
    {
        id: 2,
        name: 'Joyhauser',
        spotlight: false,
        image: 'assets/images/Artists/Joyhauser_360x360.jpg',
        genres: ['techno'],
        home: 'Belgium',
        description: 'Part of Belgium\'s new generation of exceptional techno talents, Joyhauser are a potent partnership with the drive, determination and experience to deliver each and every time. The culmination of a friendship formed in 2004, Joyhauser represents the combined talent of Joris Cielen and Stijn Vanspauwen.',
    },
    {
        id: 3,
        name: 'CamelPhat',
        spotlight: false,
        image: 'assets/images/Artists/CamelPhat_360x360.jpg',
    ...
    },
    {
        ...
        name: 'Massive Attack',
        spotlight: false,
        image: 'assets/images/Artists/MassiveAttack_360x360.jpg',
    ...
    },
    {
        ...
        name: 'Hot Since 82',
        spotlight: false,
        image: 'assets/images/Artists/HotSince82_360x360.jpg',
        genres: ['house', 'dance'],
        home: 'United Kingdom',
    ...
    },
    {
        ...
        name: 'Nora En Pure',
        spotlight: false,
        image: 'assets/images/Artists/NoraEnPure_360x360.jpg',
        genres: ['deep house'],
        home: 'South Africa',
    ...
    },
    {
        ...
        name: 'John Summit',
        spotlight: false,
        image: 'assets/images/Artists/JohnSummit_360x360.jpg',
        genres: ['tech house'],
        home: 'Chicago',
        description: 'Hailing from a city steeped in house culture, Chicago’s John Summit has quickly become the hottest name in dance music following the success of ‘Deep End’ on Defected Records in June 2020 which became the longest-running Beatport #1 of the year and was named Pete Tong’s Essential New Tune before landing on Radio 1’s main playlist. Since then Summit has gone on to release a series of groundbreaking originals including ‘Thin Line’ on D4 Dance that’s amassed over 7 million total streams, as well as ‘Beauty Sleep’ on Repopulate Mars and ‘Make Me Feel’ on Insomniac; both of which sat atop Beatport’s overall chart.'
    },
    {
        id: 13,
        name: 'Dombresky',
        spotlight: false,
        image: 'assets/images/Artists/Dombresky_360X360.jpg',
        genres: ['house'],
        home: 'France',
        description: 'French dance music producer, Quentin Dombres or professionally known as Dombresky has been producing music for nearly a decade and a half now.'
    },
    {
        id: 14,
        name: 'Dubfire',
        spotlight: false,
        image: 'assets/images/Artists/Dubfire_360x360.jpg',
        genres: ['house', 'techno'],
        home: 'Washington',
    ...
    },
    {
        ...
        name: 'Nic Fanciulli',
        spotlight: false,
        image: 'assets/images/Artists/NicFanciulli_360x360.jpg',
    ...
    },
    {
        ...
        name: 'Claptone',
        spotlight: false,
        image: 'assets/images/Artists/Claptone_360x360.jpg',
    ...
    },
    {
        ...
        name: 'ARTBAT',
        spotlight: false,
        image: 'assets/images/Artists/ARTBAT.jpg',
